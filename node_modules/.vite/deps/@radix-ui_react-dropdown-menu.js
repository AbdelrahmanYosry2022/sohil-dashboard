...
import {
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-VXYZVQ3Q.js";
import {
  createContextScope
} from "./chunk-4L5XZA4A.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-VNXI6C7O.js";
import {
  require_react_dom
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React29.useRef(false);
  ...
  return (0, import_jsx_runtime10.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime10.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime10.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React29.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime10.jsx)(PortalProvider, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime10.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var MenuContent = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime10.jsx)(Collection2.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime10.jsx)(Collection2.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime10.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime10.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
var MenuRootContentModal = React29.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React29.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime10.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React29.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React29.useState(null);
    const contentRef = React29.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React29.useRef(0);
    const searchRef = React29.useRef("");
    const pointerGraceTimerRef = React29.useRef(0);
    const pointerGraceIntentRef = React29.useRef(null);
    const pointerDirRef = React29.useRef("right");
    const lastPointerXRef = React29.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React29.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React29.useCallback((event) => {
      var _a, _b;
    ...
    return (0, import_jsx_runtime10.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React29.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React29.useCallback(
          (event) => {
            var _a;
        ...
        onPointerGraceIntentChange: React29.useCallback((intent) => {
          pointerGraceIntentRef.current = intent;
        }, []),
        children: (0, import_jsx_runtime10.jsx)(ScrollLockWrapper, { ...scrollLockWrapperProps, children: (0, import_jsx_runtime10.jsx)(
          FocusScope,
          {
            asChild: true,
            trapped: trapFocus,
...
var MenuGroup = React29.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...groupProps } = props;
    return (0, import_jsx_runtime10.jsx)(Primitive.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
MenuGroup.displayName = GROUP_NAME2;
var LABEL_NAME = "MenuLabel";
var MenuLabel = React29.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...labelProps } = props;
    return (0, import_jsx_runtime10.jsx)(Primitive.div, { ...labelProps, ref: forwardedRef });
  }
);
MenuLabel.displayName = LABEL_NAME;
var ITEM_NAME2 = "MenuItem";
var ITEM_SELECT = "menu.itemSelect";
var MenuItem = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React29.useState("");
    React29.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
    ...
    return (0, import_jsx_runtime10.jsx)(
      Collection2.ItemSlot,
      {
        ...
        children: (0, import_jsx_runtime10.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: (0, import_jsx_runtime10.jsx)(
          Primitive.div,
          {
            role: "menuitem",
...
var MenuCheckboxItem = React29.forwardRef(
  (props, forwardedRef) => {
    const { checked = false, onCheckedChange, ...checkboxItemProps } = props;
    return (0, import_jsx_runtime10.jsx)(ItemIndicatorProvider, { scope: props.__scopeMenu, checked, children: (0, import_jsx_runtime10.jsx)(
      MenuItem,
      {
...
var MenuRadioGroup = React29.forwardRef(
  (props, forwardedRef) => {
    const { value, onValueChange, ...groupProps } = props;
    const handleValueChange = useCallbackRef(onValueChange);
    return (0, import_jsx_runtime10.jsx)(RadioGroupProvider, { scope: props.__scopeMenu, value, onValueChange: handleValueChange, children: (0, import_jsx_runtime10.jsx)(MenuGroup, { ...groupProps, ref: forwardedRef }) });
  }
);
MenuRadioGroup.displayName = RADIO_GROUP_NAME;
var RADIO_ITEM_NAME = "MenuRadioItem";
var MenuRadioItem = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React29.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React29.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React29.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React29.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React29.useEffect(() => {
    ...
    return (0, import_jsx_runtime10.jsx)(MenuAnchor, { asChild: true, ...scope, children: (0, import_jsx_runtime10.jsx)(
      MenuItemImpl,
      {
...
var MenuSubContent = React29.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
    ...
    const ref = React29.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime10.jsx)(Collection2.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime10.jsx)(Collection2.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime10.jsx)(
      MenuContentImpl,
      {
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime11.jsx)(Root32, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
DropdownMenu.displayName = DROPDOWN_MENU_NAME;
var TRIGGER_NAME = "DropdownMenuTrigger";
var DropdownMenuTrigger = React30.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, disabled = false, ...triggerProps } = props;
    const context = useDropdownMenuContext(TRIGGER_NAME, __scopeDropdownMenu);
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime11.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime11.jsx)(
      Primitive.button,
      {
        type: "button",
...
var DropdownMenuContent = React30.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React30.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel = React30.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React30.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React30.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem = React30.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React30.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator = React30.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React30.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime11.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var DropdownMenuSubTrigger = React30.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime11.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
});
DropdownMenuSubTrigger.displayName = SUB_TRIGGER_NAME2;
var SUB_CONTENT_NAME2 = "DropdownMenuSubContent";
var DropdownMenuSubContent = React30.forwardRef((props, forwardedRef) => {
